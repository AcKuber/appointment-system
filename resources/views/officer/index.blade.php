...
<div id="update_officer" tabindex="-1" aria-hidden="true" 
	...
	<div 
		...
		<form class="space-y-6" action="{{ route('officer_insert') }}" method="POST" id="update_officer_form">
			...
			<div>
				<label for="ustatus" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Status</label>
				<select name="status" id="ustatus" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
					<option value="Active">Active</option>
					<option value="Inactive">Inactive</option>
				</select>
				<small name="status" class="bottom-0 left-0 hidden"></small>
